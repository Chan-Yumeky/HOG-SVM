...
# 训练集图片的位置
train_image_path = 'D:\PyCharm\project\HOG_SVM_IMG-master\HOG_SVM_IMG-master\old\image128'
# 测试集图片的位置
test_image_path = 'D:\PyCharm\project\HOG_SVM_IMG-master\HOG_SVM_IMG-master\old\image128'

# 训练集标签的位置
train_label_path = os.path.join('D:\PyCharm\project\HOG_SVM_IMG-master\HOG_SVM_IMG-master\old\image128', 'train.txt')
# 测试集标签的位置
test_label_path = os.path.join('D:\PyCharm\project\HOG_SVM_IMG-master\HOG_SVM_IMG-master\old\image128', 'test.txt')
